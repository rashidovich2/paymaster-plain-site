...
class Database{
	...
	//private $db_user = "p7014";  // Change as required
	//private $db_pass = "87602431";  // Change as required
	//private $db_name = "hi-english";	// Change as required
	private $db_host = "odnoplatniki.net";  // Change as required
	private $db_user = "c7674";  // Change as required
	private $db_pass = "yyoR7qn0";  // Change as required
	private $db_name = "c7674_new";	// Change as required
	...
	public function connect(){
		if(!$this->con){
			...
			if($this->myconn->connect_errno > 0){
				...
				//mysqli_query("SET CHARACTER SET RESULTS 'utf8'");
				//mysqli_query("SET character_set='utf8'");
				//mysqli_query("SET character_set_results='utf8'");
				//mysqli_query("SET collation_connection='utf8_general_ci'");
				//$this->myconn->set_charset('utf8');
				//$this->myconn->query("SET NAMES utf8");
				//$this->myconn->query("SET CHARACTER SET 'utf8'");
				//$this->myconn->query("SET CHARACTER SET RESULTS 'utf8'");
				//$this->myconn->query("SET character_set='utf8'");
				//$this->myconn->query("SET character_set_results='utf8'");
				//$this->myconn->query("SET collation_connection = @@collation_database");
				//$this->myconn->query("SET collation_connection='utf8_general_ci'");
                //mysqli_query("SET NAMES 'utf8'");
                //mysqli_query("SET CHARACTER SET 'utf8'");
	...
	public function charset(){
		if($this->con){
			$charsett= $this->myconn->character_set_name();
			return $charsett;
		}
	}
